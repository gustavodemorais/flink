...
(
    ...
    PRIMARY KEY (tenant_id, supplier_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'suppliers_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, product_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'products_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, category_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'categories_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, customer_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'customers_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, warehouse_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'warehouses_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, shipping_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'shipping_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, payment_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'payment_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
(
    ...
    PRIMARY KEY (tenant_id, product_id, warehouse_id) NOT ENFORCED
      ...
      'connector' = 'upsert-kafka',
      'topic' = 'inventory_topic_multi_100k',
      'properties.bootstrap.servers' = 'localhost:9092',
      'key.format' = 'json',
      'value.format' = 'json'
      );
...
-- SELECT CAST(1 + tenant_id/100 AS STRING) AS tenant_id,
--        tentant_name,
--        email,
--        registration_date,
--        loyalty_level,
...
-- SELECT CAST(1 + tenant_id/100 AS STRING) AS tenant_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS supplier_id,
--        supplier_name,
--        contact_person,
--        phone,
--        address,
...
-- SELECT CAST(1 + tenant_id/100 AS STRING) AS tenant_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS product_id,
--        product_name,
--        category_id,
--        brand,
--        1 + MOD(tenant_id, 100) AS supplier_id,
--        cost,
--        weight,
--        product_rating,
--        is_active,
...
-- SELECT CAST(1 + tenant_id/100 AS STRING) AS tenant_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS category_id,
--        category_name,
--        description,
--        parent_category,
--        is_active,
...
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS supplier_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS category_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS customer_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS warehouse_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS shipping_id,
--        CAST(1 + MOD(tenant_id, 100) AS STRING) AS payment_id,
--        quantity,
--        unit_price,
--        order_time,
--        region,
