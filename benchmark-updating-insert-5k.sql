...
--         'connector' = 'upsert-kafka',
--       'topic' = 'join_results_mj_topic_5k',
--       'properties.bootstrap.servers' = 'localhost:9092',
--       'key.format' = 'json',
--       'value.format' = 'json'
...
--     'connector' = 'upsert-kafka',
--       'topic' = 'join_results_binary_topic_5k',
--       'properties.bootstrap.servers' = 'localhost:9092',
--       'key.format' = 'json',
--       'value.format' = 'json'
