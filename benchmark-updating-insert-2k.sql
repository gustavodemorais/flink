...
--         'connector' = 'upsert-kafka',
--       'topic' = 'join_results_mj_topic_2k',
--       'properties.bootstrap.servers' = 'localhost:9092',
--       'key.format' = 'json',
--       'value.format' = 'json'
...
--     'connector' = 'upsert-kafka',
--       'topic' = 'join_results_binary_topic_2k',
--       'properties.bootstrap.servers' = 'localhost:9092',
--       'key.format' = 'json',
--       'value.format' = 'json'
